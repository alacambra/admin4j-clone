 ...
 *
 */
@ProductDependencies( {Product.JDBC30} )
@PackageRestrictions({"net.admin4j","java","javax"})
public class PreparedStatementWrapper30 extends PreparedStatementWrapper30Base {
    
    public PreparedStatementWrapper30(ConnectionWrapper30Base connection, PreparedStatement statement) {

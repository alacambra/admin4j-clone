...
public class TestJdkLoggingExceptionHandler {
    
    private JdkLoggingExceptionHandler handler;

    @Before
    public void setUp() throws Exception {
        handler = new JdkLoggingExceptionHandler();
    }
    ...
    public void testBasic() throws Exception{
        LogRecord record = new LogRecord(Level.SEVERE, "Boo");
